...
class DelegatedAuth : public QObject
{
  ...
  public:
	...
	DelegatedAuth( const QString &clientId, const QString &clientSecret, const QString &tokenStorePath,
  ...
  private:
	...
	void pollForToken( const QString &deviceCode, int intervalSecs, qint64 deadlineEpoch,

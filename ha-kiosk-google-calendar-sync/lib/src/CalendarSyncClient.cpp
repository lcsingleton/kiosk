	...
	: QObject( parent ), m_socketPath( socketPath )
{
	...
	connect( &m_socket, &QLocalSocket::errorOccurred, this,
			 [this]( QLocalSocket::LocalSocketError ) { m_reconnectTimer.start(); } );
...
QString CalendarSyncClient::sendCommand( const QString &action, const QString &calendarId,
										 const QString &eventId, const QString &etag,
										 const QJsonObject &payload )
{
	...
	if ( m_socket.state() != QLocalSocket::ConnectedState )
	{
		...
		QTimer::singleShot( 0, this, [this, commandId]() {
			emit commandFailed( commandId, QStringLiteral( "upstream_unavailable" ),
...
QString CalendarSyncClient::rescheduleEvent( const QString &calendarId, const QString &eventId,
...
QString CalendarSyncClient::cancelEvent( const QString &calendarId, const QString &eventId,
										 const QString &etag )
{
	return sendCommand( QStringLiteral( "CancelEvent" ), calendarId, eventId, etag, QJsonObject() );
}

QString CalendarSyncClient::renameEvent( const QString &calendarId, const QString &eventId,
										 const QString &etag, const QString &newSummary )
{
...
QString CalendarSyncClient::changeEventLocation( const QString &calendarId, const QString &eventId,

...
// confidence. The CALENDAR table (24 colors, used for a whole calendar's
// own default/list color) is reproduced from public documentation of
// Google's convention rather than verified against a live account — if a
